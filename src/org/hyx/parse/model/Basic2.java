...
public class Basic2 {
	...
	public String getLatteraddress() {
		return latteraddress;
	}

	public void setLatteraddress(String latteraddress) {
		this.latteraddress = latteraddress;
	}
	...
	public String toString() {
		return "Basic [" + "name=" + name + ", gender=" + gender + ", company="
				...
				+ ", workingyear=" + workingyear + ", education=" + education
				+ ", latteraddress=" + latteraddress + ", maritalstatus="
				+ maritalstatus + ", account=" + account + ", phone=" + phone
				+ ", mobile=" + mobile + ", email=" + email + ", age=" + age
				+ ", birth=" + birth + ", degree=" + degree
				+ ", expectnaturework=" + expectnaturework
				+ ", expectindustry=" + expectindustry + ",currentSalary="
